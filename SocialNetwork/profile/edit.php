...
if (!empty($_REQUEST['lang'])) {
    if (isset($_REQUEST['next']) && checkLenght($_REQUEST['email'], 1, 20) && checkLenght($_REQUEST['name'], 1, 20) &&
        checkLenght($_REQUEST['surname'], 1, 20) && checkLenght($_REQUEST['age'], 1, 20) &&
        checkLenght($_REQUEST['city'], 1, 20)) {
        ...
        mysqli_query($link, "UPDATE users SET email='$email', name='$name', surname='$surname', age='$age', city='$city', lang='$lang' WHERE id='$id'") || die (mysqli_error($link));
        ...
        <form action="" method="POST">
            ...
            <p>
                ...
                <select name="lang" id="lang" style="width: 172px;">
                    ...
                    <option value="eng" <?php echo $_REQUEST['lang'] === 'eng' ? 'selected="select"' : ''; ?>>English
                    </option>
