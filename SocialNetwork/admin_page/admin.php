...
if (isAdmin() === true) {
    ...
    <div style="width: 100%;">
        ...
        <form style="width: 800px; margin: 10px auto;" action="post" method="POST"><input type="submit" name="back"
                                                                                          value="Обратно к профилю">
        </form>
        <div style="width: 800px; margin: 10px auto;">
            ...
            ?>
            <p>администраторов -- <?php echo $res[10]; ?></p>
            <p>модераторов -- <?php echo $res[2]; ?></p>
            <p>пользователей -- <?php echo $res[1]; ?></p>
