...
$link = mysqli_connect(DB_SERVER, DB_USER, DB_PASSWORD) || die(ERROR_CONNECT);

mysqli_query($link, "CREATE DATABASE IF NOT EXISTS " . DATABASE . "") || die(mysqli_error($link));
...
mysqli_query($link, 'SET NAMES utf8') || die(mysqli_error($link));
