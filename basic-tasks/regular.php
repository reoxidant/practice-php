...
<?php 
// Тема: Задачи на регулярные выражения PHP. Часть 1
// Тема: Задачи на ".", символы.
...
// echo preg_replace('#a.b#', '!', 'ahb acb aeb aeegb affb attb');
...
// echo preg_replace('#ab?a#', '!', 'aa aba abba abca abea');
...
// Тема: Задачи на экранировку

// 8. Дана строка 'a.a aba aea'. Напишите регулярку, которая найдет строку a.a, не знахватив остальные.
