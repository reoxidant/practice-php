...
?>
	<div class="basket">
		<div>
			<a href="total-cart.php"><img src="cart.png" alt=""></a>
	...
	<div class="main">
		<div class="row">
			<div>
				...
				<p>
					<a class="btn" href="?price=<?php echo countItem($price[0], $count); ?>&items= <?php echo $_SESSION['item']+1; ?>">Положить в корзину</a>
				</p>
			</div>
			<div>
				...
				<p>
					<a class="btn" href="?price=<?php echo countItem($price[1], $count); ?>&items= <?php echo $_SESSION['item']+1; ?>">Положить в корзину</a>
				</p>
			</div>
			<div>
				...
				<p>
					<a class="btn" href="?price=<?php echo countItem($price[2], $count); ?>&items= <?php echo $_SESSION['item']+1; ?>">Положить в корзину</a>
				</p>
			</div>
		</div>
		<div>
			<h3>IPhone 7 <<Черный оникс>> 128 гб</h3>
			<img src="7.jpg" alt="7">
			<p><b>Цена: <?php echo $price[3]; ?> р.</b></p>
			<p>
				<a class="btn" href="?price=<?php echo countItem($price[3], $count); ?>&items= <?php echo $_SESSION['item']+1; ?>">Положить в корзину</a>
			</p>
		</div>
		<div>
			...
			<p>
				<a class="btn" href="?price=<?php echo countItem($price[4], $count); ?>&items= <?php echo $_SESSION['item']+1; ?>">Положить в корзину</a>
			</p>
		</div>
	</div>
	<?php 
